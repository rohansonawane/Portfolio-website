...
const projects = [
  {
    ...
    icons: [
      { icon: <FaPython key="python" />, key: "python" },
      { icon: <SiTensorflow key="tensorflow" />, key: "tensorflow" },
      { icon: <SiPytorch key="pytorch" />, key: "pytorch" },
      { icon: <SiScikitlearn key="scikit" />, key: "scikit" },
      { icon: <SiPandas key="pandas" />, key: "pandas" },
      { icon: <SiNumpy key="numpy" />, key: "numpy" },
      { icon: <SiKeras key="keras" />, key: "keras" },
      { icon: <SiJupyter key="jupyter" />, key: "jupyter" }
    ],
  ...
  },
  {
    ...
    icons: [
      ...
      { icon: <SiAframe key="aframe" />, key: "aframe" },
      { icon: <FaServer key="server" />, key: "server" },
      { icon: <FaHtml5 key="html" />, key: "html" },
      { icon: <FaCss3 key="css" />, key: "css" },
      { icon: <FaCloud key="cloud" />, key: "cloud" },
      { icon: <FaTools key="tools" />, key: "tools" }
    ],
  ...
  },
  {
    ...
    icons: [
      { icon: <SiReact key="react" />, key: "react" },
      { icon: <SiD3Dotjs key="d3" />, key: "d3" },
      { icon: <SiMapbox key="mapbox" />, key: "mapbox" },
      { icon: <FaPhp key="php" />, key: "php" },
      { icon: <FaDatabase key="database" />, key: "database" },
      { icon: <FaChartLine key="chart" />, key: "chart" },
      { icon: <FaTools key="tools" />, key: "tools" }
    ],
    github: null,
  ...
  },
  {
    ...
    icons: [
      ...
      { icon: <FaCss3 key="css" />, key: "css" },
      { icon: <FaTools key="tools" />, key: "tools" },
      { icon: <FaCode key="code" />, key: "code" },
      { icon: <FaServer key="server" />, key: "server" },
      { icon: <FaBrain key="brain" />, key: "brain" }
    ],
